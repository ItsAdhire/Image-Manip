...
/**
 * Represents a set of tests for the Greyscale class.
 */
public class GreyscaleTest {
  ...
  public void testInvalidInitializationConstructor1() {
    try {
      ImageOp op1 = new Greyscale(null, "Northeastern");
    ...
    try {
      ImageOp op2 = new Greyscale("Husky", null);
      fail("Should have thrown IllegalArgumentException");
    }
    catch (IllegalArgumentException e) {
      if (!(e.getMessage().equals("Given a null argument"))) {
    ...
    try {
      ImageOp op3 = new Greyscale(null, null);
      fail("Should have thrown IllegalArgumentException");
    }
    catch (IllegalArgumentException e) {
      if (!(e.getMessage().equals("Given a null argument"))) {
  ...
  public void testInvalidInitializationConstructor2() {
    try {
      ImageOp op1 = new Greyscale(null);
      fail("Should have thrown IllegalArgumentException");
    }
    catch (IllegalArgumentException e) {
      if (!(e.getMessage().equals("Given a null argument"))) {
  ...
  public void testValidExecuteImageModel0() {
    ImageOp op1 = new Greyscale("single");
    op1.execute(im0);
  ...
  public void testValidExecuteImageModel1() {
    ImageOp op1 = new Greyscale("wide", "wide-changed");
    op1.execute(im1);
  ...
  public void testValidExecuteImageModel2() {
    ImageOp op1 = new Greyscale("tall", "tall-changed");
    op1.execute(im2);
  ...
  public void testValidExecuteImageModel3() {
    ImageOp op1 = new Greyscale("square", "square-changed");
    op1.execute(im3);

    int[] out0 = new int[]{0x010101, 0x020202, 0x333333, 0xFFFF00};
    int[] out1 = new int[]{0x010101, 0x020202, 0x333333, 0xEDEDED};
    ...
    ImageOp op2 = new Greyscale("single", "square");
    op2.execute(im3);

    int[] out2 = new int[]{0xFF00FF};
    int[] out3 = new int[]{0x494949};
  ...
  public void testInvalidExecute() {
    ImageOp op1 = new Greyscale("Boston");
    try {
      op1.execute(im0);
    ...
    ImageOp op2 = new Greyscale("hello", "goodbye");
    try {
      op2.execute(im1);
      fail("Should have thrown IllegalStateException");
    }
    ...
    ImageOp op3 = new Greyscale("trapezoid", "trapezoid");
    try {
      op3.execute(im2);
      fail("Should have thrown IllegalStateException");
    }
    ...
    ImageOp op4 = new Greyscale("tall");
    try {
      op4.execute(im3);
      fail("Should have thrown IllegalStateException");
    }
